...
sequenceDiagram
    ...
    browser->>server: Java script calls GET https://studies.cs.helsinki.fi/exampleapp/data.json
    activate server
    server-->>browser: [{ "content": "HTML is easy", "date": "2023-1-1" }, ... ]
    deactivate server

    Note right of browser: The JS renderders the browser page using DOM-API

    browser->>browser: DOM manipulation done
